...
```bash
# 1. Get specs
uvx expedait-cli projects download 1 --output-dir ./specs

# 2. List pages to get IDs
uvx expedait-cli pages list --project-id 1 --format json
# [{"id": 10, "title": "PRD", ...}, {"id": 11, "title": "BRD", ...}]

# 3. Read PRD content
uvx expedait-cli pages get 10
# Returns markdown content...

# 4. Post comment about a divergence in the PRD
uvx expedait-cli comments create 10 \
...
uvx expedait-cli comments create 11 \
